...
app.use((req, res, next) => {
    //
    let allowedOrigins = [`http://www.yubaopay.com.tw`, `http://47.244.143.129:3000`, 'http://localhost:8080', 'http://localhost:3000'];
...
app.post('/bills/findMyBills', isAuthenticated('User'), dgPayment.findMyBills_2);
